...
<body>
<?php require_once 'back_edit.php' ?>
...
<div class="max-w-2xl mx-auto">
    <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
        <a href="show.php?id=<?php echo $_GET['id']?>" class="mb-5 font-medium text-sm inline-flex items-center text-blue-500 hover:text-blue-800">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <form action="back_update.php?id=<?php echo $_GET['id'] ?>" method="POST">
                <div class="mb-4">
                    <div>
                        <label for="name"
                    ...
                    <div class="sm:col-span-2 mt-3">
                        ...
                        <textarea id="description" name="content" rows="10"
