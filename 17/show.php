...
<section class="bg-white dark:bg-gray-900">
    <div class="py-8 px-4 mx-auto max-w-2xl">
        <div class="mb-5">
            <a href="index.php" class="font-medium text-sm inline-flex items-center text-blue-500 hover:text-blue-800">
        ...
        <div class="flex flex-wrap gap-2 mt-1">
            <a href="category_select.php?id=<?php echo $_GET['id'] ?>"
               class="<?php echo $_GET['hide'] == '1' ? "hidden" : "" ?> inline-flex items-center text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 font-medium rounded-lg text-sm px-5 py-2.5 mr-0 text-center me-2">
                <svg class="mr-1 -ml-1 w-5 h-5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                     viewBox="0 0 24 24">
            ...
            <a href="?id=<?php echo $_GET['id'] ?>&hide=1"
               class="<?php echo $_GET['hide'] == '1' ? "hidden" : "" ?>  inline-flex items-center text-white bg-black hover:bg-gray-800 font-medium rounded-lg text-sm px-5 py-2.5 mr-0 text-center me-2">
                <svg class="mr-1 -ml-1 w-5 h-5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                     viewBox="0 0 24 24">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <?php if ($is_published !== '1'): ?>
                <a href="?publish=1&id=<?php echo $_GET['id'] ?>"
                   class="<?php echo $_GET['hide'] == '1' ? "hidden" : "" ?>  inline-flex items-center text-white bg-green-700 hover:bg-gray-800 font-medium rounded-lg text-sm px-5 py-2.5 mr-0 text-center me-2">
            ...
            <?php endif; ?>
            <?php if ($is_published == '1'): ?>
                <a href="?publish=0&id=<?php echo $_GET['id'] ?>"
                   class="<?php echo $_GET['hide'] == '1' ? "hidden" : "" ?>  inline-flex items-center text-white bg-green-700 hover:bg-gray-800 font-medium rounded-lg text-sm px-5 py-2.5 mr-0 text-center me-2">
                    <svg class="mr-1 -ml-1 w-5 h-5" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                         fill="none"
                         viewBox="0 0 24 24">
            ...
            <a href="edit.php?id=<?php echo $_GET['id'] ?>"
               class="<?php echo $_GET['hide'] == '1' ? "hidden" : "" ?> inline-flex items-center text-white ml-0 bg-yellow-400 hover:bg-yellow-500 focus:outline-none focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-yellow-900">
            ...
            <form action="back_destroy.php?id=<?php echo $_GET['id'] ?>" method="POST">
                <button type="button"
                        class="<?php echo $_GET['hide'] == '1' ? "hidden" : "" ?> inline-flex items-center text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-900">
